namespace DogShelter.WebApi.Tests.Controllers
{
    using System;
    ...
    using DogShelter.WebApi.Controllers;
    using Domain.Model;
    using Dto;
    ...
    {
        private readonly Mock<IDogShelterService> mockDogShelterService = new Mock<IDogShelterService>();

        [Fact]
        public void DogShelterController_Create_WithNull_DogShelterService_Failure()
        {
            Assert.Throws<ArgumentNullException>(() => new DogShelterController(null));
        }
